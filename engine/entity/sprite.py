...
class Sprite(Entity):
    ...
    def __init__(self, res: Resolution, *, speed: int = 1, scalar: float = 1, gravity: bool = True, min_y: int = 0):
        ...
        self._index = 0
        self._scalar = scalar
        self._max_y = res.height - min_y - 123
    ...
    def tick(self, tick_count: int) -> None:
        ...
        if self._gravity:
            self._velocity = (vel_x, min(20, vel_y + 1))
